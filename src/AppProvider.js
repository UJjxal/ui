...
import {ACCESS_GROUPS, GATEWAYBASED} from "./config";
                    ...
                    if (KPIPublishedTreeList.length > 0) {
                        KPIPublishedTreeList.forEach((tree) => {
                            if (
                                ...
                                try {
                                    treeAttributes = tree.attributes && JSON.parse(tree.attributes)
                                } catch (e) {
                                    console.log(e)
                                }
                                let treeUnit = "";
                                try {
                                    treeUnit = JSON.parse(tree.unit)
                                } catch (e) {
                                    console.log(e)
                                }
                                let treePolarity = "";
                                try {
                                    treePolarity = JSON.parse(tree.polarity)
                                } catch (e) {
                                    console.log(e)
                                }
