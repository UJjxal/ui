import {
    addOptionsForData,
    deleteOptionsForData,
    getOptionsForData,
    updateOptionsForData,
    updateOptionsForDataTable
    ...
    if (data.code == 200) {
        ...
        entities.forEach((elem, i) => {
            ...
            dataTablesWithFields[
                ...
                key: elem.fieldName + '#' + i,
                expression: elem.expression || '',
                columnFilter: elem.columnFilter,
                filterExpression: elem.filterExpression || ''
            });
        });
