        ...
        <>
            <div className="container-fluid">
                <div className="pl10 pr10 pt10 mb20">
                    ...
                    <Breadcrumb route={props.route} menuContent={props.menuContent} activeTab={activeTab}
                                domainBased={props.domainBased}/>
                </div>
            </div>
...
const Breadcrumb = (props) => {
    ...
    const getAllLinks = () => {
        ...
        const checkChildren = (parent, crumbLinks) => {
            ...
            if (linkFound === false) {//check for Domain Trees
                ...
                if (props.domainBased && parent.displayName === selectedAssetClass) {
                    ...
                    tempcrumbLinks.push({
                        title: props.route[0].displayName,
        ...
        if (props.route[0].link === props.menuContent[props.activeTab].link) {
            foundLink = true;
            crumbLinks.push({
                title: props.menuContent[props.activeTab].displayName,
