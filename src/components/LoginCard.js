    ...
    const handleSubmit = async (e) => {
        ...
        try {
            let response = await axios({
                method: 'post', url: API_ROOT + 'loginApi',
                data: {username, password}, timeout: 30000,
            });
    ...
    return <div className="ant-modal-root login-card d-none" style={{zIndex: 10000}}>
        ...
        <div className="ant-modal-wrap">
            <div role="document" className="ant-modal row justify-content-center">
                <div className="ant-modal-content px-2 py-4 w-100 text-center justify-content-center rounded"
                     style={{maxWidth: '520px'}}>
                    <div className="container px-0">
                        <div className="row justify-content-center">
                            <div className="col-8 text-center">
                                <img className="p-3" src="/refresh-session.svg" alt="refresh-session"/>
                                <h4 className="text-primary-blue mb-2">Your session has expired</h4>
                                <p className="font-weight-normal fs14 mb-3">If you want to continue session as <span
                                    className='text-primary-blue text-capitalize'>{loginData ? loginData['name'] : 'user'}</span>,
                                    please re-write your password.</p>
                                ...
                                <Button size="small"
                                        className={`outline-none ${isLoading ? 'bg-light text-muted' : 'bg-primary-blue text-white'} px-3 py-1`}
