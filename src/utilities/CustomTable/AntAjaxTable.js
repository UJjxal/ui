                ...
                <div className="d-flex justify-content-between mb-3">
                    ...
                    <div>
                        {props.exportExcel ? <ExportTableButton
                            ...
                            showColumnPicker
                        >
                            <i className="fas fa-file-export" style={{color: '#205684'}}
                               title="Export Data into CSV"></i>
                        </ExportTableButton> : null}
                        {props.hideShowCol ?
                            <TableColumn columns={d.columns} columnShowHideChange={columnShowHideChange}/> : null}
