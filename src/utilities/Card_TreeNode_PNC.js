...
import {MDBCard, MDBCardBody, MDBCardFooter, MDBIcon, MDBNavLink} from 'mdbreact';
                            ...
                            <MDBCardBody className="d-flex flex-column p-2 pl-3">
                                ...
                                <MDBNavLink style={{padding: '0px'}} exact to={props.navLinkTo}>
                                    ...
                                    >
                                        ...
                                        <MDBIcon className="mr-2" style={{fontSize: '1rem', color: '#111111'}}
                                                 icon="chevron-right"/>
                                    </div>
                                </MDBNavLink>
                                <div>
                                            ...
                                            if (key[0] != 'node_status') {
                                                return (
                                                    <div key={key} className="d-flex">
                                                        ...
                                                        <span style={{maxWidth: '8rem'}}
                                                              className="home-node-attr-1 mr-1">{props.unit && props.unit[key[0]] === '$' ? convertToInternationalCurrencySystem(key[1]) : key[1]}</span>
                                                        <span className="home-node-attr-1 mr-2">
															{props.unit && props.unit[key[0]]}
														</span>
                                                        <span style={{maxWidth: '8rem'}}
                                                              className="home-node-attr-2">{key[0]}</span>
                                                    </div>
                                                );
                                            }
                                        })}
