...
import {ADVISOR_DASHBOARD_URL1, API_ROOT, CONTEXT} from "../../../config";
                                ...
                                <div className="w-100">
                                    ...
                                    <TabPanel value={valueVer} index={4}>
                                        <div className="d-flex justify-content-between pb-1">
                                            <div
                                                className="align-items-center border d-flex justify-content-around p-2 rounded-pill">
                                                <Icon>search</Icon>
                                                <input
                                                    type="text"
                                            ...
                                            <div className="bordered-2 rounded">
                                                <table className="table table-borderless">
                                                    ...
                                                    <tr className="border-top">
                                                        <td className="d-flex justify-content-end pb-0">
