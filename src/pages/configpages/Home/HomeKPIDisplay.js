            ...
            {props.KPIMenuContent.length > 0
                ...
                <div className="w-100 row align-items-center justify-content-center my-5">
                    ...
                    <div className="col-md-4 text-center">
                        ...
                        <p className="fs16">There are no {props.listLoading ? `saved` : `published`} KPI Trees created
                            yet for this asset. Any new KPI Tree is created in drafts and eventually published once all
                            the needful nodes, cohorts, etc. are created.</p>
                    </div>
                </div>
            }
        </>
