...
import { Modal, Table, DatePicker, Menu, Dropdown } from 'antd';
...
import { listActions, createAction, updateAction, deleteAction, pushAction, markAsCompleteAction } from "../../../services/I2AService";
        ...
        <div>
            ...
            <div className="row mx-0 justify-content-center pb-4 mb-2" style={{ borderBottom: "1px solid #cdd6e0" }}>
                ...
                <div className="col-md-5 text-md-right">
                    ...
                    <Button color="primary" variant="outlined"><Link to={CONTEXT + getUri(props.menuContent, "I2A/actionsMonitoring")}>See All Actions</Link></Button>
                </div>
            </div>
                ...
                {ACTION_EXPERIMENTS ? (<>
                    ...
                    JSON.parse(data.actionExperiments).map((item, idx) => {
                        ...
                        return <div key={idx} className="mt-2">
                            <div className="d-flex justify-content-between align-items-center border-bottom pb-2">
                                <h6 className="fs14 mb-0">{item.expType} Experiment - <span className="text-primary-blue text-capitalize">{(item.expStatus).toLowerCase()}</span></h6>
                    ...
                    <div className="row m-0 mt-3 justify-content-around w-100">
                        ...
                        <div className="col-8 p-0 text-center">
                            ...
                            <div className="span small mb-2">Experiments allow you to test the effectiveness of an action or variants of an action on a subset a cohort.</div>
