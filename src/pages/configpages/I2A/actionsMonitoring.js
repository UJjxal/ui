...
import {Button, Card, FormControl, Icon, InputAdornment, MenuItem, OutlinedInput, Select} from "@material-ui/core";
...
const ActionsMonitoring = () => {
    ...
    const fetchActionsMonitoring = () => {
        setIsLoading(true);
        const data = {
            currentPeriodEndDate: `${selectedYear}-12-31T00:00:00`,
            currentPeriodStartDate: `${selectedYear}-01-01T00:00:00`
        };
            ...
            .then(({data}) => {
                if (data.code === 200) {
                    setMonitoringData({
                        ...
                        headerInfo: data.response.actionMonitoringHeaderInfo
                    });
                ...
                render: (_, record) => {
                    return <>
                        ...
                        <div className="d-flex justify-content-center align-items-center">
                            ...
                            <ReactEcharts className="row m-0" style={{height: '70px', width: '120px'}}
                                          option={getOption(record.chartData)}/>
        ...
        <div className="container-fluid px-5 py-4">
            <div className="row">
                            ...
                            <div className="col" style={{color: '#090A0B'}}>
                                ...
                                <div className="row">
                                    ...
                                    <span className="col text-right">
                                        <Icon className="p-0"
                                              style={{fontSize: '70px', color: '#9BADC1'}}>tips_and_updates_black</Icon>
                                    </span>
                                </div>
                        ...
                        <Card className="col border py-3 shadow-sm">
                            <div className="col" style={{color: '#090A0B'}}>
                                ...
                                <div className="row">
                                    ...
                                    <span className="col text-right">
                                        <Icon className="p-0"
                                              style={{fontSize: '70px', color: '#9BADC1'}}>published_with_changes</Icon>
                                    </span>
                                </div>
                                <div
                                    className="row  opacity-50">{monitoringData.headerInfo?.recommendedAction} Recommendations
                                </div>
                            </div>
                        </Card>
                    </div>
                        ...
                        <Card className="col border py-3 shadow-sm">
                            <div className="col" style={{color: '#090A0B'}}>
                                ...
                                <div className="row">
                                    ...
                                    <span className="col text-right">
                                        <Icon className="p-0"
                                              style={{fontSize: '70px', color: '#9BADC1'}}>science_black</Icon>
                                    </span>
                                </div>
                                <div
                                    className="row  opacity-50">From {monitoringData.headerInfo?.recommendedAction} Actions
                                </div>
                            </div>
                        </Card>
                    </div>
                        ...
                        <Card className="col border py-3 shadow-sm">
                            <div className="col" style={{color: '#090A0B'}}>
                                ...
                                <div className="row">
                                    ...
                                    <span className="col text-right">
                                        <Icon className="p-0"
                                              style={{fontSize: '70px', color: '#9BADC1'}}>check_circle_black</Icon>
                                    </span>
                                </div>
                                <div
                                    className="row  opacity-50">{monitoringData.headerInfo?.totalExperiments} Experiments
                                </div>
                            </div>
                        </Card>
                    </div>
                ...
                <div className="col-md-12 mb-5">
                    <div className="row justify-content-between border rounded mx-0 mb-1 py-3"
                        ...
                        <div className="col-md-5">
                            ...
                            <Button color="primary" className="outline-none">
                                <Icon className="align-middle font-weight-bold"
                                      title="Search Actions">filter_list</Icon>
                            </Button>
                        </div>
                        ...
                        (monitoringData.data).length > 0 ?
                            ...
                            <div className="w-100 row align-items-center justify-content-center my-5">
                                ...
                                <div className="col-md-4 text-center">
                                    <h4>No Actions!</h4>
                                    <p className="fs16">There are no actions which are currently running or completed.
                                        The performance of all the running or completed actions will automatically
                                        show-up on this view.</p>
                                </div>
                            </div>
                    }
                </div>
