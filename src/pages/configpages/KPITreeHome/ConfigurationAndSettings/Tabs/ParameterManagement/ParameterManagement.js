    ...
    return isLoading ? <Loader className="mt-3 text-center"/> :
        <div className="container px-0">
            <div className="d-flex justify-content-between pb-3">
                ...
                <Button variant="contained" className="bg-primary-blue text-white px-3 py-1"
            ...
            {parameterList.length > 0 || create ?
                    ...
                    <div className="col-md-5 pl-md-2">
                        <div className="border rounded p-3">
                            {selectedRowKeys.length ? (
                                <MultipleSelected deleteParameter={deleteParameter} selectedRows={selectedRowKeys}
                                                  onSelectChange={onSelectChange}/>
                            ) : selected ? (
                                <OneSelected
                ...
                <div className="w-100 row align-items-center justify-content-center my-5">
                    ...
                    <div className="col-md-4 text-center">
                        ...
                        <p className="fs16">There are no parameters created yet. Parameters help you track and manage
                            strategies to improve your Key Metrics. Click the New parameters button to get started.</p>
                    </div>
                </div>
            }
        </div>
