        ...
        <MDBContainer fluid flexCenter>
            ...
            <MDBRow className="mt-1">
                ...
                <MDBCard style={{width: "40%"}}>
                    <MDBCardBody className="pl-2 ml-0 pb-0">
                                ...
                                {props.profile !== "pie" ?
                                    <MDBTableBody className="mb-0">
                                        <tr>
                                            ...
                                            <td md="10" className="p-0 pt-1">
                                                The combination of Switch to Competition and Financial Barrier is the
                                                top reason of Discontinuation for 25% of the existing patient population
                                            </td>
                                        </tr>
                                        <tr>
                                            <td md="2" className="pt-1">
                                            ...
                                            <td md="10" className="p-0 pt-1">
                                                The Payer Denial from CVS, AETNA, and ANTHEM is the 2nd highest Reason
                                                of Discontinuation for 20% of the patient population
                                            </td>
                                        </tr>
                                        <tr>
                                            <td md="2" className="pt-1">
                                            ...
                                            <td md="10" className="p-0 pt-1">
                                                The combination of Side Effects and Physician Reco. is the 3rd reason of
                                                Discontinuation for 15% of the patients
                                            </td>
                                        </tr>
                                        <tr>
                                            <td md="2" className="pt-1">
                                            ...
                                            <td md="10" className="p-0 pt-1">
                                                Highest discontinuation rate of 20% drop at Y1 Q4 driven by financial
                                                factors, is maximum for the Age Group 60-65, Race: Hispanic, Gender:
                                                Female
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td md="10" className="p-0 pt-1">
                                                Physicians decision is the 2nd most important driver for
                                                discontinuation, among Age Group 40-45, Race: White, Gender: Female,
                                                States: GA, NV, PA
                                            </td>
                                        </tr>
                                    </MDBTableBody>
                                    : <MDBTableBody className="mb-0">
                                        <tr>
                                            ...
                                            <td md="10" className="p-0 pt-1">
                                                Highest discontinuation rate of 20% drop at Y1 Q4 driven by financial
                                                factors, is maximum for the Age Group 70-80, Race: White, Gender: Female
                                            </td>
                                        </tr>
                                        <tr>
                                            <td md="2" className="pt-1">
                                            ...
                                            <td md="10" className="p-0 pt-1">
                                                Physicians decision is the 2nd most important driver for
                                                discontinuation, among Age Group 50-55, Race: Asian, Gender: Female,
                                                States: CA, NV, MA
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td md="10" className="p-0 pt-1">
                                                The combination of Side Effects and Physician Reco. is the 3rd reason of
                                                Discontinuation for 35% of the patients
                                            </td>
                                        </tr>
                                        <tr>
                                            <td md="2" className="pt-1">
                        ...
                        <MDBBtnGroup>
                            <MDBBtn className="mr-3" size="sm" color="primary" onClick={() => setVisible(1)}>High Risk
                                Patient (Discontinuation) </MDBBtn>
            ...
            >
                {visible === 2 ?
                    ...
                    : visible === 1 ?
                        props.profile !== "pie" ?
                            <Table dataSource={dataSourceBar2} columns={columns2} pagination={false}
                                   scroll={{x: '120vw'}} bordered/>
                            :
                            <Table dataSource={dataSourcePie2} columns={columns2} pagination={false}
                                   scroll={{x: '120vw'}} bordered/>
                        : null
                }
            </Modal>
    ...
    options: {
        ...
        tooltip: {
            ...
            custom: function ({series, seriesIndex, dataPointIndex, w}) {
                ...
                if (val === 85) {
                    perc = [30, 40, 15, 15];
                    label = ["Side Effects", "Financial", "Switch Drugs", "Payer"];
                }
                if (val === 80) {
                    perc = [45, 35, 20, 10];
                    label = ["Side Effects", "Financial", "Fullfilment", "Payer"];
                ...
                if (val === 40) {
                    perc = [20, 15, 40, 25];
                    label = ["Side Effects", "BV/PA", "Switch Drugs", "Payer"];
                }
                if (val === 35) {
                    perc = [20, 25, 50, 5];
                    label = ["Side Effects", "Financial", "Switch Drugs", "Death"];
                }
                if (val === 30) {
                    perc = [10, 10, 60, 20];
                    label = ["Side Effects", "Financial", "Physician Reco.", "Payer"];
                }
