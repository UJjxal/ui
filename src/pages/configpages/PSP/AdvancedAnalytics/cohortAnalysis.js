            ...
            {content === null ? <>
                ...
                <div className="my-4 border p-3 d-flex flex-wrap">
                    ...
                    <div className="mb-2">
                        ...
                        <DatePicker.RangePicker style={{width: 220, marginRight: "10px"}}
                                                onChange={(e) => handleFilter(e, `Date of Enrollment`)}/>
                    </div>
                    <div className="mb-2">
                        <h6 className="mb-0">Date of First Fill </h6>
                        <Select defaultValue="ALL"
                                style={{width: 220, marginRight: "10px"}}
                                onChange={(e) => handleFilter(e, `firstFill`)}>
                    ...
                    <div className="mb-2">
                        ...
                        <DatePicker style={{width: 220, marginRight: "10px"}}
                                    onChange={(e) => handleFilter(e, `Date of Enrollment`)}/>
                    </div>
                    <div className="mb-2">
                ...
                <MDBRow className="mt-1 mx-auto">
                    <MDBCard className="mx-2" style={{maxWidth: "350px"}}>
                        <MDBCardBody className="pb-0 text-center">
                            <img src={`${CONTEXT}/static/media/gear.38edfac1.svg`}
                                 style={{height: "4rem", width: "4rem"}}/>
                            <a onClick={() => setContent("PatientProfile")} className="nav-link Ripple-parent"
                               style={{display: "inline", paddingLeft: "0px"}}>
                                <h5 className="text-center" style={{paddingTop: "1rem"}}>Identify Discontinuation
                                    Drivers for patients on Therapy</h5>
                            </a>
                        </MDBCardBody>
                    </MDBCard>
                    <MDBCard className="mx-2" style={{maxWidth: "350px"}}>
                        <MDBCardBody className="pb-0 text-center">
                            <img src={`${CONTEXT}/static/media/price.cc209037.svg`}
                                 style={{height: "4rem", width: "4rem"}}/>
                            <a className="nav-link Ripple-parent" style={{display: "inline", paddingLeft: "0px"}}>
                                <h5 className="text-center" style={{paddingTop: "1rem"}}>Identify Non Adherence Drivers
                                    for Patients on therapy</h5>
                            </a>
                        </MDBCardBody>
                    </MDBCard>
                </MDBRow>
