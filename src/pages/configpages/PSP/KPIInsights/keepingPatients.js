                        ...
                        <li>
                            ...
                            <ul>
                                <li>
                                    ...
                                    <ul className="children">
                                        <li>
                                            ...
                                            <a onClick={() => setContent("Illustrative V")}
                                               className="d-block mb-1 bg-light">Adherence Rate/ Score</a>
                                            ...
                                            <a onClick={() => setContent("Illustrative III")}
                                               className="d-block mb-1 bg-light">Refill Outlier</a>
                                            <a href="#" className="d-block mb-1">Time on Therapy</a>
                                            <a href="#" className="d-block mb-1">Avg. Days in patient journey phase</a>
                                            <a onClick={() => setContent("Illustrative3")}
                                               className="d-block mb-1 bg-light">Patient Experience Score</a>

                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a onClick={() => setContent("Illustrative IV")}
                                       className="sub-parent">Discontinuation</a>
                                    <ul className="children">
                                        <li>
                                            <a href="#" className="d-block mb-1"># Discontinued Patients</a>
                                            <a href="#" className="d-block mb-1">Discontinued Rate</a>
                                            <a href="#" className="d-block mb-1">Moving average of discontinued
                                                patients</a>
                                ...
                                <li>
                                    ...
                                    <ul className="children">
                                        <li>
                                            <a href="#" className="d-block mb-1">Time from approval to local
                                                reimbursement</a>
