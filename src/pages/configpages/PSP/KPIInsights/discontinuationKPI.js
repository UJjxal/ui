...
import {MDBBtn, MDBBtnGroup, MDBCard, MDBCardBody, MDBCardText, MDBCardTitle, MDBContainer, MDBRow,} from 'mdbreact';
                ...
                <MDBCard className="w-100">
                    <MDBCardBody className="d-flex">
                        <div className="col border-right">
                            ...
                            <MDBCardText>
                                % of Patient (on treatment) who discontinued the recommended treatment/ total Patients
                                on treatment
                            </MDBCardText>
                            ...
                            <div class="mt-5 pt-3">
                                <h6
                                    ...
                                    <strong>Discontinuation %</strong> has decreased from 47% to 41% between 2018 Q1 and
                                    2019 Q4
                                </h6>
                            </div>
                        </div>
                        <div className="col border-right">
                                ...
                                <li className="d-flex justify-content-between">
                                    <span>
                                        <b
                                            ...
                                            <CaretRightFilled
                                                style={{color: "#ef8600", fontSize: "30px", verticalAlign: "top"}}/>
                                        <span
                                            style={{
                                                padding: "0 20px 5px 0",
                                                fontSize: "20px"
                            ...
                            <div class="mt-4">
                                <h6
                                    ...
                                    <strong>Financial - Coverage Denial %</strong> grew from 2.5% to 5.3% between 2018
                                    Q1 and 2019 Q4
                                </h6>
                            </div>
                        </div>
                        <div className="col">
                            ...
                            <div class="mt-4 pt-3">
                                <h6
                                    ...
                                    <strong>Drug switch to Clozaril</strong> has decreased from 8.3% in 2018Q1 to 5 % in
                                    2019Q4
                                </h6>
                            </div>
                        </div>
