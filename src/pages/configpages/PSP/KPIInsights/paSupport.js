                            ...
                            <MDBTable>
                                <MDBTableBody className="mb-0">
                                    <tr>
                                        ...
                                        <td className="align-middle"><h5 className="text-nowrap mb-0">Prior Auth.
                                            TAT</h5></td>
                                        <td className="align-middle pr-0"><h5 className="mb-0 font-weight-bold">12%</h5>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle"><h5 className="text-nowrap mb-0">Appeals TAT</h5>
                                        </td>
                                        <td className="align-middle pr-0"><h5 className="mb-0 font-weight-bold">21%</h5>
                                        </td>
                                        <td md="2" className="pl-1 align-middle">
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle"><h5 className="text-nowrap mb-0">PA Approval %</h5>
                                        </td>
                                        <td className="align-middle pr-0"><h5 className="mb-0 font-weight-bold">14%</h5>
                                        </td>
                                        <td md="2" className="pl-1 align-middle">
