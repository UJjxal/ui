                        ...
                        <MDBTable>
                            <MDBTableBody className="mb-0">
                                <tr>
                                    ...
                                    <td className="align-middle"><h5 className="text-nowrap mb-0">Active Patients</h5>
                                    </td>
                                    <td className="align-middle pr-0"><h5
                                        className="mb-0 font-weight-bold text-right">35900</h5></td>
                                ...
                                <tr>
                                    ...
                                    <td className="align-middle"><h5 className="text-nowrap mb-0">Adherence Score</h5>
                                    </td>
                                    <td className="align-middle pr-0"><h5
                                        className="mb-0 font-weight-bold text-right">6.6</h5></td>
                                    <td md="2" className="pl-1 align-middle">
                                        <MDBIcon className="red-text" size="3x" icon="caret-down"/>
                                    </td>
                                    <td md="10" className="p-0 pt-1">
                                        <a onClick={() => props.setContent(`Illustrative V`)} style={{
                                            cursor: "pointer",
                                            color: "blue",
                                            textDecoration: "underline"
                                        }}>{`• Adherence Score between age group 40-50 has dropped to 4.7 (by 9.2 %) between Nov '20 - Dec '20`}</a><br/>
                                ...
                                <tr>
                                    ...
                                    <td className="align-middle"><h5 className="mb-0">Adherence Outliers (Days)</h5>
                                    </td>
                                    <td className="align-middle pr-0"><h5
                                        className="mb-0 font-weight-bold text-right">16-20</h5></td>
                                    <td md="2" className="pl-1 align-middle">
                                        <MDBIcon className="red-text" size="3x" icon="caret-up"/>
                                    </td>
                                    <td md="10" className="p-0 pt-1">
                                        <a onClick={() => props.setContent(`Illustrative III`)} style={{
                                            cursor: "pointer",
                                            color: "blue",
                                            textDecoration: "underline"
                                        }}>{`• Adherence Refill Outlier is maximum between the period 16-20 days in Dec '20`}</a><br/>
                                    </td>
                                </tr>
                            </MDBTableBody>
                        </MDBTable>
