                                ...
                                <MDBTableBody className="mb-0">
                                    <tr>
                                        ...
                                        <td className="align-middle pr-0"><h5
                                            className="mb-0 font-weight-bold text-right">31</h5></td>
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle"><h5 className="mb-0">Patient pickup delays (Gap
                                            Days)</h5></td>
                                        <td className="align-middle pr-0"><h5
                                            className="mb-0 font-weight-bold text-right">11</h5></td>
                                        <td md="2" className="pl-1 align-middle">
                                    ...
                                    <tr>
                                        ...
                                        <td className="align-middle"><h5 className="text-nowrap mb-0">Drop Offs</h5>
                                        </td>
                                        <td className="align-middle pr-0"><h5
                                            className="mb-0 font-weight-bold text-right">15%</h5></td>
                                        <td md="2" className="pl-1 align-middle">
                                            <MDBIcon className="red-text" size="3x" icon="caret-up"/>
                                        </td>
                                        <td md="10" className="p-0 pt-1">
