...
const DailyDetailed = () => {
    ...
    return (
        <div className="p-4">
            ...
            <div className="mb-5">
                <h5 className="text-center mb-1 py-2" style={{background: "#e6f7ff"}}>DAILY REPORT by - Switching to
                    Comp/ Treatment Duration</h5>
                <Table dataSource={data.dataSource.Daily_Report_Switching_to_Comp} columns={columnsPharmacy}
