...
const Summary = () => {
    ...
    const handleFilter = (value, label) => {
        ...
        setData({
            dataSource: {...data.dataSource, "Daily_Summary": filteredDaily, "Monthly_Summary": filteredMonth},
            columns: []
        });
    }
    ...
    return (
        <div className="p-4">
            ...
            <div className="mb-5">
                ...
                <Table dataSource={data.dataSource.Monthly_Summary} columns={columnsMonthly} pagination={{pageSize: 5}}
                       bordered/>
            </div>
        </div>
    )
