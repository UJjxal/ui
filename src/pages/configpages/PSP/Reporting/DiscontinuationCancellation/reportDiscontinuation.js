...
const DailyDetailed = () => {
    ...
    const handleFilter = (value, label) => {
        ...
        setData({
            dataSource: {
                ...data.dataSource,
                "Patient_Level_Data": filteredInput,
                "Daily_Report_Discontinuation_Re": filteredAuth,
                "Daily_Report_Switching_to_Comp": filteredPharma
            }, columns: []
        });
    }
    ...
    return (
        <div className="p-4">
            ...
            <div className="mb-5">
                <h5 className="text-center mb-1 py-2" style={{background: "#e6f7ff"}}>DAILY REPORT by- Discontinuation
                    Reason / Treatment Duration</h5>
                <Table dataSource={data.dataSource.Daily_Report_Discontinuation_Re} columns={columnsAuthorization}
