    ...
    const handleFilter = (value, label) => {
        ...
        setData({
            dataSource: {
                ...data.dataSource,
                "Input": filteredInput,
                "AuthorizationStatus": filteredAuth,
                "PharmacyStatus": filteredPharma
            }, columns: []
        });
    }
    ...
    return (
        <div className="p-4">
            ...
            <div className="mb-5">
                ...
                <Table dataSource={data.dataSource.AuthorizationStatus} columns={columnsAuthorization}
                       pagination={{pageSize: 5}} bordered/>
            </div>
            <div className="mb-5">
                <h5 className="text-center mb-1 py-2" style={{background: "#e6f7ff"}}>PHARMACY STATUS</h5>
                <Table dataSource={data.dataSource.PharmacyStatus} columns={columnsPharmacy} pagination={{pageSize: 5}}
                       bordered/>
            </div>
        </div>
    )
