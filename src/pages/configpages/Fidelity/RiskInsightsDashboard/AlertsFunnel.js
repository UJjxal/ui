                    ...
                    <div>
                        <div className="position-relative" style={{overflow: 'hidden'}}>
                            <div className="d-flex position-relative" style={{zIndex: 2}}>
                                ...
                                <div className="wper20 greybg31 border-right">
                                    ...
                                    <div className="pt20 pb15 pl20 pr20 position-relative">
                                        ...
                                        <div className="pt10">
                                            ...
                                            <div>{duplicates > 0 ? (duplicates * 100 / statusCount.total).toFixed(0) : 0}%
                                                of {statusCount.total}</div>
                                        </div>
                                    </div>
                                </div>
                                <div className="wper20 greybg31 border-right">
                                ...
                                <div className="wper20 greybg31">
                                    ...
                                    <div className="pt20 pb15 pl20 pr20 position-relative">
                                        ...
                                        {/* <BgDiv heightPer="4" /> */}
                                        <div className="pt10">
                                            <div><strong>*Under Action Taken</strong><br/>=Total Alerts - Duplicates
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="position-absolute" style={{zIndex: 1, left: '0', bottom: 0, width: '100%'}}>
                                <svg viewBox="0 0 500 80" style={{width: '100%', strokeWidth: '0px'}}
                                     xmlns="http://www.w3.org/2000/svg">
                                    <path d="M 0 80 C -60 0, 0 10, 100 40 S 320 50, 500 80" stroke="black"
                                          fill="#AFE3FC" style={{border: 'none'}}/>
                                </svg>
                            </div>
                        </div>
                    </div>
