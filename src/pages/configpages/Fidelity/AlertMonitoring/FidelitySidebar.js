                                                ...
                                                <div className="border p-2 bg-white">
                                                    <MDBCard className="p-2">
                                                        {Object.keys(treeInfo).length > 0 ?
                                                            <>
                                                                <div>
                                                                    <a href={treeInfo.url ? treeInfo.url : ""}
                                                                       target="_blank" style={{
                                                                        fontSize: "16px",
                                                                        color: "#205684",
                                                                        fontWeight: "500"
                                                                    ...
                                                                    <i className="d-block"
                                                                       style={{fontSize: "10px"}}>{treeInfo.source}{treeInfo.source && treeInfo.publicationDate ? "," : ""} {treeInfo.publicationDate}</i>
                                                                </div>
                                                                {
                                                                    treeInfo.keywords &&
                                                                    <div>
                                                                        <ul className="d-block mt-2 p-0 mb-1"
                                                                            style={this.getKeywordStyle()}>
                                                                            {this.conversionJson().map((item, i) => {
                                                                                    return (
                                                                                        <li key={i}
                                                                                            className="keywords-tags mb-1">{item}</li>
                                                                                    )
                                                                                }
                                                                            )}
                                                                        </ul>
                                                                        <button onClick={this.toggle}
                                                                                className="keywords-tags tags-btn">{this.state.active ? 'View Less' : 'View More'}</button>
                                                                    </div>
                                                                }
                                                            </>
