...
import {MDBCol, MDBModal, MDBModalBody, MDBModalFooter, MDBRow, MDBTable, MDBTableBody, MDBTableHead} from "mdbreact";
                ...
                <MDBTable small className="m-0">
                    ...
                    <MDBTableBody>
                        {d.item?.rows?.map((rw, rn) => (
                            <tr key={rn}>
                                <td width="45%">
                                    <select className="form-control" value={rw[0].selectedValue || ''}
                                            onChange={e => handleChange(e, rw[0])}>
                                        {rw[0].option.map((v, i) => (
                                ...
                                <td width="45%">
                                    <select className="form-control" value={rw[1].selectedValue || ''}
                                            onChange={e => handleChange(e, rw[1])}>
                                        {rw[1].option.map((v, i) => (
                                            <option key={i} value={v.key}>{v.value}</option>
                                        ))}
                                    </select>
