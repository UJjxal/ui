...
const StudyParameters = (props) => {
    ...
    let {
        dvtableData, setNDC, ndc, setoptimalvalues, briefTitle, briefDesc, sponsor,
        investigator, indication, phase, indicationList, demographicList, vitalList, reachData
    } = props;
...
ant-select-selection--single" type="text" value={sponsor} style={{
                                                    padding: '0px 9px',
                                                    width: '60%',
...
ant-select-selection--single" style={{width: '93.5%', height: '2.7rem', fontSize: '13.5px', resize: 'none'}}
                                                          readOnly>{briefTitle}</textarea>
                                            </InputGroup>
                                            <InputGroup style={inputGroup} compact><label
                                                style={inputLabel}>Description</label>
                                                <textarea className="ant-select-selection
ant-select-selection--single" style={{width: '93.5%', height: '4.4rem', fontSize: '13.5px', resize: 'none'}}
                                                          readOnly>{briefDesc}</textarea>
                                            </InputGroup>
                                    ...
                                    <Col style={{width: '100%'}}>
                                        ...
                                        >
                                            ...
                                            >
                                                    ...
                                                    <div className=''
                                                        ...
                                                        <MDBCard className="" style={{height: '12rem'}}>
                                                            <MDBCardBody className="pt-1"
                                                                         style={{lineHeight: '11px', width: '103%'}}>
                                                                <MDBTable
                                                                    small
                                                                ...
                                                                >
                                                                    <MDBTableHead style={inputLabelWidth}>
                                                                        <tr>
                                                                            ...
                                                                            <th style={{width: '20%'}}>Additional Data
                                                                                Capture
                                                                            </th>
                                                                        </tr>
                                                                    </MDBTableHead>
                                                                    <MDBTableBody className="mb-0">
                                                                        ...
                                                                        <ProviderDrug segment={segment}
                                                                                      toggleDrug={toggleDrug}
                                                                                      reachData={reachData}/>
                                                                        <RelativeSites relative={relative}
                                                                                       toggleSites={toggleSites}
                                                                                       ndc={ndc}/>
                                                                        <RelativeProcedure primary={primary}
                                                ...
                                                <TabPane tab="Inclusion/Exclusion" key={2}
                                                         style={{"margin-left": "-3px"}}>
                                                    <MDBRow className="mt-2 d-flex justify-content-around">
                                                        <MDBCol>
                                                            <MDBCard className=""
                                                                     style={{height: '23rem', "margin-left": "-12px"}}>
                                                                <MDBCardBody style={{
                                                                    overflowY: 'scroll',
                                                                    "margin-top": "-25px"
                                                                }}>
                                                                    <MDBCardText className="d-flex flex-column mt-2">
                                                                        ...
                                                                        {indicationList ? (indicationList.rows.map((indication) => (
                                                                            ...
                                                                            <Loader type="Grid" height={30} width={30}
                                                                                    color="#00BFFF"/>
                                                                        )}
                                    ...
                                    <div className="" style={{width: '50%'}}>
                                        ...
                                        <React.Fragment>
                                            ...
                                            <InputGroup style={inputGroup} compact>
                                                <label style={inputLabel}>Sponsor</label>
                                                <input className="ant-select-selection ant-select-selection--single"
                                                       type="text" style={{padding: '0px 9px', width: '60%'}}/>
                                    ...
                                    <Col style={{width: '100%'}}>
                                        ...
                                        >
                                            ...
                                            >
                                                            ...
                                                            <MDBCardBody className="pt-1"
                                                                ...
                                                                >
                                                                    ...
                                                                    <MDBTableBody className="mb-0">
                                                                        ...
                                                                        <ProviderDrugCreateNew segment2={segment2}
                                                                                               toggleDrug2={toggleDrug2}
                                                                                               ndc={ndc}/>
                                                                        <RelativeSitesNew relative2={relative2}
                                                                                          toggleSites2={toggleSites2}
                                                                                          ndc={ndc}/>
                                                                        <RelativeProcedureCreateNew primary2={primary2}
                                                                                                    toggleProc2={toggleProc2}
                                                                                                    ndc={ndc}/>
                                                                    </MDBTableBody>
                                                                </MDBTable>
                                                            </MDBCardBody>
                                                ...
                                                <TabPane tab="Inclusion/Exclusion" key={4}
                                                         style={{"margin-left": "-3px"}}>
                                                    <MDBRow className="mt-2 d-flex justify-content-around">
                                                        <MDBCol>
                                                            <MDBCard className=""
