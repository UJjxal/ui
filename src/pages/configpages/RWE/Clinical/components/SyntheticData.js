    ...
    return (
        <MDBModal isOpen={props.SCAdisplay} toggle={() => setCancel()} className="cascading-modal mt-5" size="fluid">
            ...
            <MDBModalBody className="pt-0">
                ...
                <MDBCard className=""
                         style={{height: '21rem', overflow: 'scroll', display: CTSCAdisplay1 ? 'block' : 'none'}}>
                ...
                <MDBCard className=""
                         style={{height: '21rem', overflow: 'scroll', display: CTSCAdisplay2 ? 'block' : 'none'}}>
                    <MDBCardBody className="pt-1" style={{lineHeight: '11px', overflow: 'scroll'}}>
                        <MDBTable
                            small
                            className="border" border="1"
                ...
                <MDBCard className=""
                         style={{height: '21rem', overflow: 'scroll', display: EHRSCAdisplay1 ? 'block' : 'none'}}>
                    <MDBCardBody className="pt-1" style={{lineHeight: '11px', overflow: 'scroll'}}>
                        <MDBTable
                            small
                            className="border" border="1"
                ...
                <MDBCard className=""
                         style={{height: '21rem', overflow: 'scroll', display: EHRSCAdisplay2 ? 'block' : 'none'}}>
                    <MDBCardBody className="pt-1" style={{lineHeight: '11px', overflow: 'scroll'}}>
                        <MDBTable
                            small
                            className="border" border="1"
