...
const FinalizeStudy = (props) => {
    ...
    let {
        similarstudiesData, literatureData, ndc, altData,
                                        ...
                                        <React.Fragment>
                                            ...
                                            <InputGroup style={inputGroup} compact>
                                                <svg height="100%" width="100%"
                                                     style={{padding: '0px 122px', marginBottom: '-39px'}}>
                                                    <circle cx="55" cy="55" r="55"
                                                            fill={patientAttrition >= 0 && patientAttrition < 11 ? 'green' : null || patientAttrition > 11 && patientAttrition < 40 ? 'orange' : null || patientAttrition > 40 ? 'red' : null}/>
                                                    <text x="40" y="62" fill="white" style={{
                                                        fontWeight: 'bold',
                                                        fontSize: '23px'
                                                    }}>{patientAttrition}%
                                                    </text>
...
ant-select-selection--single" style={{width: '80%', "padding-top": "0px", height: "62px", resize: 'none'}}
                                        ...
                                        >
                                            ...
                                            >
                                                <TabPane tab="Inclusion/Exclusion" key={1}>
                                                    <MDBRow className="mt-1 d-flex justify-content-around" style={{
                                                        width: '100%',
                                                        height: '250px',
                                                        'overflow-x': 'hidden'
                                                    }}>
                                                            ...
                                                            <MDBCardBody className="p-0 pt-1">
                                                                ...
                                                                <MDBCardText className="text-center">
                                                                    {finalizeStudyLoading ?
                                                                        ...
                                                                        : (
                                                                            bladderdata && <BarChart
                                                                                categories={bladderdata.categories}
                                                        ...
                                                        <MDBCard style={{width: '45%', marginBottom: '10px'}}>
                                                            <MDBCardBody className="p-0 pt-1">
                                                                ...
                                                                <MDBCardText className="text-center">
                                                                    {stageofcancerdata ? (
                                                                        <BarChart
                                                                            categories={stageofcancerdata.categories}
                                                        ...
                                                        <MDBCard style={{
                                                            width: '45%',
                                                            marginBottom: '10px',
                                                            display: ndc === 'NCT00234494' || ndc === 'NCT00461851' || ndc === 'NCT01282463' ? 'inline' : 'none'
                                                        }}>
                                                            <MDBCardBody className="p-0 pt-1">
                                                                <MDBCardTitle tag="h5" className="text-center"
                                                                              style={{color: 'black'}}>
                                                                ...
                                                                <MDBCardText className="text-center">
                                                                    {otherfracturedata ? (
                                                                        <BarChart
                                                                            categories={otherfracturedata.categories}
                                                        ...
                                                        <MDBCard style={{
                                                            width: '45%',
                                                            marginBottom: '10px',
                                                            display: ndc === 'NCT02302807' ? 'inline' : 'none'
                                                        }}>
                                                        ...
                                                        <MDBCard style={{
                                                            width: '45%',
                                                            marginBottom: '10px',
                                                            display: ndc === 'NCT00461851' || ndc === 'NCT01108055' ? 'inline' : 'none'
                                                        }}>
                                                            <MDBCardBody className="p-0 pt-1">
                                                                <MDBCardTitle tag="h5" className="text-center"
                                                                              style={{color: 'black'}}>
                                                ...
                                                <TabPane tab="Intervention" key={3} style={{"margin-left": "-3px"}}>
                                                    <MDBRow className="mt-1 d-flex justify-content-around" style={{
                                                        ...
                                                        <MDBCard style={{
                                                            width: '45%',
                                                            marginBottom: '10px',
                                                            display: ndc === 'NCT00045630' ? 'inline' : 'none'
                                                        }}>
                                                            <MDBCardBody className="p-0 pt-1">
                                                                <MDBCardText className="text-center">
                                                                    {turbtdata ? (
                                                        ...
                                                        <MDBCard style={{
                                                            ...
                                                            marginBottom: '10px',
                                                            visibility: 'hidden',
                                                            display: ndc === 'NCT00234494' || ndc === 'NCT01108055' || ndc === 'NCT01282463' || ndc === 'NCT00645593' ? 'inline' : 'none'
                                                        }}>
                                                            <MDBCardBody className="p-0 pt-1">
                                                            </MDBCardBody>
                                                        </MDBCard>
                                                ...
                                                <TabPane tab="Similar Studies" key={4} style={{"margin-left": "-3px"}}>
                                                    <div className=''
                                                        ...
                                                        <MDBCard className=""
                                                                 style={{height: '14rem', 'overflow-x': 'hidden'}}>
                                                ...
                                                <TabPane tab="Literature Review" key={5}
