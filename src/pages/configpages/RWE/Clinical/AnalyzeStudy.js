...
import {MDBCard, MDBCardBody, MDBCardImage, MDBCol, MDBRow, MDBTable, MDBTableBody, MDBTableHead} from "mdbreact";
...
const AnalyzeStudy = (props) => {
    ...
    let {
        indicationList, demographicList, vitalList, ndc, briefTitle, demoData, RCTArmdata,
        CTSCA1, CTSCA2, EHRSCA1, EHRSCA2
    } = props;
    return (
