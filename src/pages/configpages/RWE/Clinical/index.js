                ...
                <MDBTabContent activeItem={this.state.activeItem}>
                    <MDBTabPane tabId="1" role="tabpanel">
                        <StudyParameters
                            ...
                            modelingWindow={this.state.modelingWindow} briefTitle={this.state.briefTitle}
                            briefDesc={this.state.briefDesc}
                            sponsor={this.state.sponsor} investigator={this.state.investigator}
                            indication={this.state.indication} phase={this.state.phase}
                            indicationList={this.state.indicationList} demographicList={this.state.demographicList}
                ...
                <MDBTabContent activeItem={this.state.activeItem}>
                    <MDBTabPane tabId="2" role="tabpanel">
                        <FinalizeStudy
                            ...
                            similarstudiesData={this.state.similarstudiesData}
                            literatureData={this.state.literatureData} ndc={this.state.ndc}
                            altData={this.state.altData} briefTitle={this.state.briefTitle}
                            patientCount={this.state.patientCount} arms={this.state.arms} drugs={this.state.drugs}
