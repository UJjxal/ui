...
import {MDBBadge, MDBBtn, MDBCollapse, MDBIcon, MDBInput, MDBModal, MDBModalBody, MDBModalFooter,} from "mdbreact";
                                ...
                                <MDBModalBody>
                                    ...
                                    >
                                        ...
                                        <MDBBtn
                                            ...
                                            style={{border: "2px solid grey", cursor: "default"}}
                                        >
                                            <img src={`${CONTEXT}/dataProfiler/azure_logo.png`}
                                                 style={{height: "4rem"}}/>
                                        </MDBBtn>
                                        <MDBBtn
                                            color="white"
                                            ...
                                            style={{border: "2px solid grey", cursor: "default"}}
                                        >
                                            <img src={`${CONTEXT}/dataProfiler/excel-logo.png`}
                                                 style={{height: "2rem"}}/>
                                        </MDBBtn>
                                        <MDBBtn
                                            color=""
                                            ...
                                            style={{border: "2px solid grey", cursor: "default"}}
                                        >
                                            <img src={`${CONTEXT}/dataProfiler/sql-server.png`}
                                                 style={{height: "4rem"}}/>
                                        </MDBBtn>
                                    </div>
                                    <MDBCollapse
