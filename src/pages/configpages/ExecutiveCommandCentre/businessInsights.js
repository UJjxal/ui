...
import {MDBCard, MDBCardBody, MDBCardTitle, MDBCol, MDBIcon, MDBModal, MDBModalBody, MDBRow} from "mdbreact";
                            ...
                            <MDBCard>
                                <MDBCardBody className="pb-0">
                                    ...
                                    <div className="d-flex justify-content-between align-items-center">
                                        ...
                                        <Select defaultValue="behave" style={{width: 240}}
                    ...
                    <MDBCard className="h-100">
                        <MDBCardBody>
                            ...
                            <div className="d-flex mt-4">
                                <Button variant="contained" color="primary" style={{background: "#3f88c5"}}
                                        onClick={() => setIsOpen(true)}>Campaign List</Button>
                                <Button variant="contained" color="primary"
                                        style={{background: "#3f88c5", marginLeft: "0.5em"}}>
                                    <Link to={`${CONTEXT}/SG9tZS1SZXNwb25zZSBQcm9wZW5zaXR5IE1vZGVscyBDcmVkaXQgQ2FyZHM=`}
                                          className="text-white">ML Ops Engine</Link>
                                </Button>
                            </div>
                        </MDBCardBody>
                    </MDBCard>
...
const keyInsights = [
    {
        ...
        description: 'Customers with high behaviour score are less likely to respond to cross sell campaigns',
        link: ''
    },
    {
        title: 'Channel Distribution',
        description: 'No. of products & total loan outstanding, are the least important factors impacting the response to cross sell campaigns ',
        link: ''
    },
    {
        title: 'Sales Conversion',
        description: 'Balance on existing card is 4 times less important that debt to income ratio ',
        link: ''
    },
]
const columns = [
...
const dataSource = [
    {
        ...
        "RecommendedList": <a style={{color: "#1f7244"}} target="_blank"
                              href={`${CONTEXT}/Campaign_123_July.csv`}><MDBIcon icon="file-csv" size="2x"/></a>
    },
    {
        "key": "2",
