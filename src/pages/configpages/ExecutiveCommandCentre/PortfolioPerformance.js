            ...
            <div className="container-fluid">
                <MDBRow className="my-4">
                    <MDBCol md="9">
                        <MDBCard>
                            <MDBCardBody>
                                <MDBCardTitle tag="h5" style={tableHeaderStyle}>Portfolio Performance Scorecard <span
                                    style={{fontSize: '14px'}}>(% Achieved based on Actual vs Target)</span></MDBCardTitle>
                                <AntdDataTable rows={record.PortfolioPerformanceScoreboard?.TableData ?? []}
                    ...
                    <MDBCol>
                        <MDBCard>
                            <MDBRow className="mx-2 mt-4">
                                <MDBCol>
                                    <Select defaultValue="allProducts" style={{width: 240}}
                                            onChange={e => changeBalanceData(e)}>
                            ...
                            <MDBRow>
                                ...
                                <MDBCol md="6">
                                    <MDBCardBody style={{height: '400px'}}>
                                        <MDBCardTitle tag="h6">Contribution of Acquisition, Cross Sell & Attrition in
                                            Growth of Portfolio Balance ($ mn)</MDBCardTitle>
                                        <EChart
                                            triggerAxis="axis"
                    ...
                    <MDBCol>
                        <MDBCard>
                            <MDBRow className="mx-2 mt-4">
                                <MDBCol>
                                    <Select defaultValue="allProducts" style={{width: 240}}
                                            onChange={e => changeAccountData(e)}>
                                        <Option value="allProducts">All Products</Option>
                                        <Option value="autoLoan">Auto Loan</Option>
                                        <Option value="mortgage">Mortgage</Option>
                                        <Option value="creditCard">Credit Card</Option>
                            ...
                            <MDBRow>
                                <MDBCol md="6">
                                    <MDBCardBody style={{height: '400px'}}>
                                        <MDBCardTitle tag="h6">YTD Portfolio Growth Trends (#
                                            Accounts)</MDBCardTitle><br/>
                                        <EChart
                                            barColor={["#007bff"]}
                                            triggerAxis="axis"
                                ...
                                <MDBCol md="6">
                                    <MDBCardBody style={{height: '400px'}}>
                                        <MDBCardTitle tag="h6">Contribution of Acquisition, Cross Sell & Attrition in
                                            Growth of Portfolio Accounts (# 1000s)</MDBCardTitle>
                                        <EChart
                                            triggerAxis="axis"
