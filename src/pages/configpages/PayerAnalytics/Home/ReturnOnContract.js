...
import {NDC, ThArea} from '../../../../utilities/AllDropDowns';
                ...
                <MDBCard style={{width: "60%"}}>
                    <MDBCardBody className="pb-0">
                        ...
                        <MDBCardText className="text-center">
                            {data ? (
                                <LineBarChart categories={data.categories} series={data.series} yaxis={data.yaxis}
                                              height={300} formatter={chartFormatDollar} formatter2={chartFormatratio}/>
                            ) : (
