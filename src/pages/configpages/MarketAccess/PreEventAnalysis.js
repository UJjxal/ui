...
import {Button, InputNumber, Modal, Select, Table, Tooltip} from "antd";
...
const PreEventAnalysis = () => {
    ...
    const updateMap = (selStates) => {
        ...
        let states = [{"name": "Alabama", "value": 0}, {"name": "Alaska", "value": 0}, {
            "name": "Arizona",
            "value": 0
        }, {"name": "Arkansas", "value": 0}, {"name": "California", "value": 0}, {
            "name": "Colorado",
            "value": 0
        }, {"name": "Connecticut", "value": 0}, {"name": "Delaware", "value": 0}, {
            "name": "District of Columbia",
            "value": 0
        }, {"name": "Florida", "value": 0}, {"name": "Georgia", "value": 0}, {
            "name": "Hawaii",
            "value": 0
        }, {"name": "Idaho", "value": 0}, {"name": "Illinois", "value": 0}, {
            "name": "Indiana",
            "value": 0
        }, {"name": "Iowa", "value": 0}, {"name": "Kansas", "value": 0}, {
            "name": "Kentucky",
            "value": 0
        }, {"name": "Louisiana", "value": 0}, {"name": "Maine", "value": 0}, {
            "name": "Maryland",
            "value": 0
        }, {"name": "Massachusetts", "value": 0}, {"name": "Michigan", "value": 0}, {
            "name": "Minnesota",
            "value": 0
        }, {"name": "Mississippi", "value": 0}, {"name": "Missouri", "value": 0}, {
            "name": "Montana",
            "value": 0
        }, {"name": "Nebraska", "value": 0}, {"name": "Nevada", "value": 0}, {
            "name": "New Hampshire",
            "value": 0
        }, {"name": "New Jersey", "value": 0}, {"name": "New Mexico", "value": 0}, {
            "name": "New York",
            "value": 0
        }, {"name": "North Carolina", "value": 0}, {"name": "North Dakota", "value": 0}, {
            "name": "Ohio",
            "value": 0
        }, {"name": "Oklahoma", "value": 0}, {"name": "Oregon", "value": 0}, {
            "name": "Pennsylvania",
            "value": 0
        }, {"name": "Rhode Island", "value": 0}, {"name": "South Carolina", "value": 0}, {
            "name": "South Dakota",
            "value": 0
        }, {"name": "Tennessee", "value": 0}, {"name": "Texas", "value": 0}, {
            "name": "Utah",
            "value": 0
        }, {"name": "Vermont", "value": 0}, {"name": "Virginia", "value": 0}, {
            "name": "Washington",
            "value": 0
        }, {"name": "West Virginia", "value": 0}, {"name": "Wisconsin", "value": 0}, {
            "name": "Wyoming",
            "value": 0
            ...
            <>
                {typeof records[0] !== "undefined" &&
                    <div>
                        ...
                        <div
                            className={"border radius6 pt5 pb5 pl10 pr10 " + (!firstOnly ? 'bg-white shadow position-absolute w-100' : '')}
                            style={!firstOnly ? {zIndex: '1000', top: '0', left: '0'} : {}}>
                            {records.map((v, i) => (
                                    ...
                                    <div className="my-auto wper10 text-right">
                                        {i === 0 &&
                                            <Button type="default" size="small" shape="round"
                                                    onClick={toggleSeeAll}>{data.length === 1 ? "1 Event" : `${data.length} Events`}</Button>
                                        }
                                    </div>
                                </div>
                            ))}
    ...
    return (
        <div className="pt15 pb15 pl25 pr25 bold400 antd-tbl-white-th overflow-auto"
             style={{height: ch/* , background:'#f7f7f7' */}}>
            <h3 style={{color: "rgb(14, 75, 113)"}}>Pre Event Analysis</h3>

            <FilterList OnChangeImpactedPlan={OnChangeImpactedPlan} OnChangeState={OnChangeState}
                        OnChangeSaleTeam={OnChangeSaleTeam} OnChangeChange={OnChangeChange}/>
                    ...
                    <div className="pt15">
                        ...
                        <div className="border radius6 pt2">
                            ...
                            <Table
                                ...
                                scroll={{y: t1h}}
                                size="small"
                                loading={rowsPlanChange === null ? {
                                    indicator: <Loader style={{marginTop: "12%"}} type="ThreeDots"/>
                                } : false}
                            />
                        </div>
                    </div>
                ...
                <div className="col-md-8 pt10 radius6" style={{background: '#F4F5F7'}}>
                    <div className="mb5 d-flex">
                        ...
                        <div className="my-auto ml-auto">
                            <Button className="radius6" type="primary" style={{background: '#065baa'}}
                                    onClick={showEmailerModal}>Trigger
                                Email {selectedHCP.count > 0 ? `(${selectedHCP.count})` : ''}</Button>
                            <Modal
                                title={
                                ...
                                footer={
                                    <div className="d-flex justify-content-center">
                                        ...
                                        <Button className="radius6" type="primary" onClick={handleOk}
                                                style={{background: '#065baa'}}>
                                            Trigger Email
                                        </Button>
                                    </div>
                                }
                            ...
                            >
                                ...
                                <EmailerTemplate selectedHCP={selectedHCP} handleCancel={handleCancel}
                                                 getNameFrCode={getNameFrCode}/>
                    ...
                    <div className="position-relative">
                        {isStFilterVisible === true &&
                            <div className="border radius6 p15 shadow bg-white w-100"
                        ...
                        <div className="border radius6 pt2">
                            <Table
                                ...
                                loading={rowsSalesTeam === null ? {
                                    indicator: <Loader style={{marginTop: "7%"}} type="ThreeDots"/>
                                } : false}
                            />
                        </div>
                    </div>
...
function TableFilter(props) {
    ...
    return (
        <div>
            ...
            <div className="d-flex">
                <div className="my-auto">
                    <Button className="radius6" onClick={() => {
                        filters.push({});
                        setFilters([...filters])
                    }} style={{border: '1px solid #043365'}}>
                        <i className="fa fa-plus mr5"></i> Add Filter
                    </Button>
                </div>
                <div className="my-auto ml-auto">
                    <Button className="radius6" type="primary" onClick={filterRecords}
                            style={{background: '#043365'}}>Done</Button>
                </div>
            </div>
        </div>
    );
