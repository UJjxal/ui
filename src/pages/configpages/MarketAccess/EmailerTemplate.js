                    ...
                    <div className="col-12">
                        <div className="rectangle72">
                            ...
                            <div className="row pdrow" style={{fontStyle: "italic"}}>
                                <div className="col  pt-0 pb-0" style={{fontSize: "15px", fontWeight: 'bold'}}>FIELD
                                    TEAMS
                                </div>
                            ...
                            <div className="row pdrow">
                                <div className="col-12">
                                    <div className="blueColored  pt-0 pb-0"
                                         style={{fontSize: "20px"}}>{emailInfo.fieldteams}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="rectangle73">
                            ...
                            <div className="row pdrow">
                                ...
                                <div className="col-6">
                                    ...
                                    <div className="row pdrow"
                                         style={{fontSize: "36px", fontFamily: "Roboto Condensed"}}>
                                        <span
                                            className="blueColored col-12"><strong> {emailInfo.totalHCPs} </strong></span>
                                    </div>
                                        ...
                                        <div className="col-9">
                                            <div className="row">
                                                <div className="col-10 pr-0">
                                                    <Button className="cancelbuttonhcp w-100"
                                                            onClick={() => handleCancel()} style={{borderRight: '0px'}}>
                                                        Click here for HCP Target List &nbsp;&nbsp;
                                                    </Button>
                                                </div>

                                                <div className="col-2"
                                                     style={{padding: '0px', flex: '0 0 0', background: '#065BAA'}}>
                                                    <Button className="cancelbuttonhcp" onClick={() => handleCancel()}
                                                            style={{padding: '0px', borderLeft: '0px'}}>
                                                        <i className="fas fa-arrow-right fa-lg" style={{
                                                            background: '#065BAA',
                                                            color: 'white',
                                                            size: '100px',
