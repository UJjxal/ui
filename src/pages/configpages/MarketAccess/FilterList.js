    ...
    const getImpactedPlan = () => {
        ...
        regeneronService.maImpactedPlan({...flData}).then(({data}) => {
            if (data.body) {
                ...
                const plans = data.body.map(plan => {
                ...
                <div className="d-flex justify-content-between">
                    ...
                    <div className="pr-2" style={{width: '16.66%'}}>
                        <div className="antd-lbl-input">
                            ...
                            <Select placeholder="Select Change" className="w-100" mode="multiple" value={flData.change}
                                    bordered={false} onChange={v => {
                                flData.change = v;
                                setFlData({...flData});
                                handleChange();
                            }}>
