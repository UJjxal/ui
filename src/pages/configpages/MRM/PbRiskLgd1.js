                ...
                <div>
                    <Tabs type="card" defaultActiveKey={0} onChange={() => {
                        ...
                        {tabs.map((tab, i) => {
                            ...
                            return (
                                <TabPane tab={<Tooltip title={tab}>
                                    <div className="mrm-tab-title">{tab}</div>
                                </Tooltip>} key={i}>
                                                ...
                                                <div className="p-3 border radius6 mb40">
                                                    <div className="row mb30">
                                                        <div className="col-md-4">
                                                            <div
                                                                className="radius6 pl15 pr15 pt20 pb20 text-center bold600 fs18"
                                                                style={lightBlueBoxStyle}>EAD
                                                            </div>
                                                        </div>
                                                        <div className="col-md-4">
                                                            <div
                                                                className="radius6 pl15 pr15 pt20 pb20 text-center bold600 fs18"
                                                                style={lightBlueBoxStyle}>LGD
                                                            </div>
                                                        </div>
                                                        <div className="col-md-4">
                                                            <div
                                                                className="radius6 pl15 pr15 pt20 pb20 text-center bold600 fs18"
                                                                style={lightBlueBoxStyle}>Avg Days to Default
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="row">
                                                        <div className="col-md-4">
                                                            <div
                                                                className="radius6 pl15 pr15 pt20 pb20 text-center bold600 fs18"
                                                                style={blueBoxStyle}>${(data[tab].ead_sum * 1).toFixed(2)}</div>
                                                        </div>
                                                        <div className="col-md-4">
                                                            <div
                                                                className="radius6 pl15 pr15 pt20 pb20 text-center bold600 fs18"
                                                                style={blueBoxStyle}>{(data[tab].lgd_mean * 1).toFixed(2)}</div>
                                                        </div>
                                                        <div className="col-md-4">
                                                            <div
                                                                className="radius6 pl15 pr15 pt20 pb20 text-center bold600 fs18"
                                                                style={blueBoxStyle}>{(data[tab].avg_default * 1).toFixed(2)} Days
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
        ...
        <div className="p-3 border radius6">
            {options !== null &&
                <div>
                    ...
                    <div
                        className={"d-flex flex-wrap noselect pt15 " + (data.length <= 3 ? 'justify-content-center' : '')}>
                        {data.map((v, i) => (
