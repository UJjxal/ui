...
import {MDBBtn, MDBCol, MDBIcon, MDBModal, MDBModalBody, MDBModalFooter, MDBRow,} from "mdbreact";
                            ...
                            <MDBRow>
                                ...
                                <MDBCol size="4">
                                            ...
                                            >
                                                <Option value="">Select Business Function</Option>
                                                {
                                                    this.state.modelTypeOptions.map((opt, i) => {
                                                        return <Option key={i} className="text-capitalize"
                                                                       value={opt.value}>{opt.label}</Option>
                                                    })
                                                }
                                            </Select>
                                            <input type="button" value="+" title="Add new item"
                                    ...
                                    {this.state.addListInput ? <div className="form-group d-flex">
                                        ...
                                        <input type="button" value="Add" className="form-control w-25 ml-2"
