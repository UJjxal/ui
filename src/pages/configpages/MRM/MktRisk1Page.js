        ...
        <div className="mrm bold400">
            ...
            {data !== null &&
                <Tabs type="card" defaultActiveKey="1" onChange={() => {
                    ...
                    <TabPane tab={<Tooltip title="Model Performance">
                        <div className="mrm-tab-title">Model Performance</div>
                    </Tooltip>} key="1">
                        <div className="row">
                            <div className="col-md-6 form-group">
                                <PortfolioTable
                                    data={data.Overall_Model_Performance[0].Validation_Result_Of_Portfolio_VaR}
                                    modelId={modelId}/>
                            </div>
                            <div className="col-md-6 form-group">
                    ...
                    <TabPane tab={<Tooltip title="Backtesting of VaR Forecasts">
                        <div className="mrm-tab-title">Backtesting of VaR Forecasts</div>
                    </Tooltip>} key="2">
                        <div className="row">
                            <div className="col-md-6 form-group">
                                <LineAreaChart title="P&L and VaR Range (VaR, 99%)"
                                               data={data.Backtesting_Of_VaR_Forecasts.VaR_99}/>
                            </div>
                            <div className="col-md-6 form-group">
                                <LineAreaChart title="P&L and VaR Range (CVaR, 99%)"
                                               data={data.Backtesting_Of_VaR_Forecasts.CVaR_99}/>
                            </div>
                            <div className="col-md-6 form-group">
                                <LineAreaChart title="P&L and VaR Range (VaR, 95%)"
                                               data={data.Backtesting_Of_VaR_Forecasts.VaR_95}/>
                            </div>
                            <div className="col-md-6 form-group">
                                <LineAreaChart title="P&L and VaR Range (CVaR, 95%)"
                                               data={data.Backtesting_Of_VaR_Forecasts.CVaR_95}/>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col">
                    ...
                    <TabPane tab={<Tooltip title="Statistical Tests">
                        <div className="mrm-tab-title">Statistical Tests</div>
                    </Tooltip>} key="3">
                        <div className="row">
                            <div className="col-md-6 form-group">
                                <BarChart
                    ...
                    <TabPane tab={<Tooltip title="Statistical Tests: Normality">
                        <div className="mrm-tab-title">Statistical Tests: Normality</div>
                    </Tooltip>} key="4">
                        <div className="row">
                            <div className="col-md-6 form-group">
                    ...
                    <TabPane tab="" tab={<Tooltip title="Portfolo Composition">
                        <div className="mrm-tab-title">Portfolo Composition</div>
                    </Tooltip>} key="5">
                    ...
                    <TabPane tab={<Tooltip title="Top Individual VaR">
                        <div className="mrm-tab-title">Top Individual VaR</div>
                    </Tooltip>} key="6">
                    ...
                    <TabPane tab={<Tooltip title="Contributor/Diversifier to VaR">
                        <div className="mrm-tab-title">Contributor/Diversifier to VaR</div>
                    </Tooltip>} key="7">
...
const Circle = (props) => {
    return (
        <div style={{
            ...
            height: '20px',
            borderRadius: '100%',
            background: (props.color === 'green' ? '#26C281' : (props.color === 'red' ? '#F2784B' : (props.color === 'orange' ? 'orange' : '#95A5A6')))
        }}>
        </div>
    )
}
    ...
    return (
        <div className="card1">
            <div className="card-body1 p2">
                <h5 className="card-title p-2 mb10">Validation Results Of Portfolio VaR Model
                    ({modelId === 'MKT_RISK2' ? '30-Jun-2021' : '30-Nov-2021'})</h5>
                <div>
                    <Table size="small" dataSource={ValidationResultsData} pagination={false} scroll={{y: 500}}
                           style={{height: 610}}>
                        <Column title="" dataIndex="vr_title" key="vr_title"/>
                        <ColumnGroup title={<div>VaR {modelId === 'MKT_RISK2' ? 'Parametric' : 'Historical'}
                        ...
                        <ColumnGroup title={<div>CVaR {modelId === 'MKT_RISK2' ? 'Parametric' : 'Historical'}
                            <div>(Confidence Level)</div>
                        </div>} align="center">
                            <Column
                                title="99%"
...
function LineAreaChart(props) {
    ...
    let cdata = typeof data[0] !== "undefined" ? {
        chart: data[0].chart,
        table: (data[1] ? data[1].table : data[0].table)
    } : {...data};
                                        ...
                                        <div className="d-flex">
                                            ...
                                            <div className="my-auto wper60 pr20">
                                                <div className="mrm-tbl-perchart-bx">
                                                    ...
                                                    <div
                                                        className={"mrm-tbl-perchart " + (v.var99 >= 0 ? 'mrm-tbl-perchart-left' : 'mrm-tbl-perchart-right')}
                                                        style={{
                                                            width: Math.abs(10 * v.var99) + '%',
                                        ...
                                        <div className="d-flex">
                                            ...
                                            <div className="my-auto wper60 pr20">
                                                <div className="mrm-tbl-perchart-bx">
                                                    ...
                                                    <div
                                                        className={"mrm-tbl-perchart " + (v.var95 >= 0 ? 'mrm-tbl-perchart-left' : 'mrm-tbl-perchart-right')}
                                                        style={{
                                                            width: Math.abs(10 * v.var95) + '%',
                                                            background: defColors[2]
                                                        }}></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="d-flex">
                                            ...
                                            <div className="my-auto wper60 pr20">
                                                <div className="mrm-tbl-perchart-bx">
                                                    ...
                                                    <div
                                                        className={"mrm-tbl-perchart " + (v.cvar99 >= 0 ? 'mrm-tbl-perchart-left' : 'mrm-tbl-perchart-right')}
                                                        style={{
                                                            width: Math.abs(10 * v.cvar99) + '%',
                                                            background: defColors[3]
                                                        }}></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div className="d-flex">
                                            ...
                                            <div className="my-auto wper60 pr20">
                                                <div className="mrm-tbl-perchart-bx">
                                                    ...
                                                    <div
                                                        className={"mrm-tbl-perchart " + (v.cvar95 >= 0 ? 'mrm-tbl-perchart-left' : 'mrm-tbl-perchart-right')}
                                                        style={{
                                                            width: Math.abs(10 * v.cvar95) + '%',
                                                            background: defColors[4]
                                                        }}></div>
                                                </div>
                                            </div>
                                        </div>
        ...
        return (
            <tr>
                {i === 0 && v.var99 >= 0 &&
                    ...
                    }} rowSpan={records.filter(v => v.var99 >= 0).length}>
                        <div className="mrm-tbl-perchart-rotate-lbl left1">Top 5 Contributor</div>
                    </td>
                }
                {i === 0 && v.var99 < 0 &&
                    <td className="position-relative"
                        style={{background: 'rgb(118 118 118)', borderRight: '3px solid #fff'}}
                        rowSpan={records.filter(v => v.var99 < 0).length}>
                    ...
                    <div className="d-flex">
                        ...
                        <div className="my-auto wper60 pr20">
                            <div className="mrm-tbl-perchart-bx">
                                ...
                                <div
                                    className={"mrm-tbl-perchart " + (v.var99 >= 0 ? 'mrm-tbl-perchart-left' : 'mrm-tbl-perchart-right')}
                                    style={{width: Math.abs(v.var99) + '%', background: defColors[0]}}></div>
                            </div>
                        </div>
                    </div>
                </td>
                    ...
                    <div className="d-flex">
                        ...
                        <div className="my-auto wper60 pr20">
                            <div className="mrm-tbl-perchart-bx">
                                ...
                                <div
                                    className={"mrm-tbl-perchart " + (v.var95 >= 0 ? 'mrm-tbl-perchart-left' : 'mrm-tbl-perchart-right')}
                                    style={{width: Math.abs(v.var95) + '%', background: defColors[2]}}></div>
                            </div>
                        </div>
                    </div>
                </td>
                    ...
                    <div className="d-flex">
                        ...
                        <div className="my-auto wper60 pr20">
                            <div className="mrm-tbl-perchart-bx">
                                ...
                                <div
                                    className={"mrm-tbl-perchart " + (v.cvar99 >= 0 ? 'mrm-tbl-perchart-left' : 'mrm-tbl-perchart-right')}
                                    style={{width: Math.abs(v.cvar99) + '%', background: defColors[3]}}></div>
                            </div>
                        </div>
                    </div>
                </td>
                    ...
                    <div className="d-flex">
                        ...
                        <div className="my-auto wper60 pr20">
                            <div className="mrm-tbl-perchart-bx">
                                ...
                                <div
                                    className={"mrm-tbl-perchart " + (v.cvar95 >= 0 ? 'mrm-tbl-perchart-left' : 'mrm-tbl-perchart-right')}
                                    style={{width: Math.abs(v.cvar95) + '%', background: defColors[4]}}></div>
                            </div>
                        </div>
                    </div>
                </td>
