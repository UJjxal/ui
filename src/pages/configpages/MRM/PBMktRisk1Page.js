            ...
            {data !== null &&
                <Tabs type="card" defaultActiveKey="1" onChange={() => {
                    ...
                    <TabPane tab={<Tooltip title="Model Performance">
                        <div className="mrm-tab-title" style={{width: 220}}>Model Performance</div>
                    </Tooltip>} key="1">
                        <div className="row">
                    ...
                    <TabPane tab={<Tooltip title="Backtesting of VaR Forecasts">
                        <div className="mrm-tab-title" style={{width: 220}}>Backtesting of VaR Forecasts</div>
                    </Tooltip>} key="2">
                        <div className="row">
                            <div className="col-md-12 form-group">
                                <LineAreaChart title="P&L and VaR Range (VaR, 95%)"
                                               data={data.Backtesting_Of_VaR_Forecasts.VaR_95[0]}/>
                            </div>
                        </div>
                        <div className="row">
                            <div className="col">
                    ...
                    <TabPane tab={<Tooltip title="Statistical Tests: Normality">
                        <div className="mrm-tab-title" style={{width: 220}}>Statistical Tests: Normality</div>
                    </Tooltip>} key="3">
                        <div className="row">
                            <div className="col-md-6 form-group">
