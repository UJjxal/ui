        ...
        <div className="mrm bold400">
            ...
            {data !== null &&
                <Tabs type="card" defaultActiveKey="1" onChange={() => {
                    ...
                    <TabPane tab={<Tooltip title="VaR by Instrument">
                        <div className="mrm-tab-title">VaR by Instrument</div>
                    </Tooltip>} key="6">
        ...
        return (
            <tr>
                {i === 0 && v.var95 >= 0 &&
                    ...
                    }} rowSpan={records.filter(v => v.var95 >= 0).length}>
