...
const Circle = (props) => {
    return (
        <div style={{
            ...
            height: '20px',
            borderRadius: '100%',
            background: (props.color === 'green' ? '#26C281' : (props.color === 'red' ? '#F2784B' : '#95A5A6'))
        }}>
        </div>
    )
}
                ...
                <div className="table-responsive">
                    <table className="table table-sm m-0">
                        ...
                        <tr>
                            ...
                            <th colSpan="2" className="bold500" style={{borderBottom: 0, paddingBottom: 0}}>VaR
                                Historical
                            </th>
                            <th colSpan="2" className="bold500" style={{borderBottom: 0, paddingBottom: 0}}>CVaR
                                Historical
                            </th>
                        </tr>
                        <tr>
            ...
            <div className="card-body p2">
                ...
                <div className="table-responsive">
                    <table className="table table-sm m-0">
                        <thead className="table-text-vmid text-center bg-light">
                        <tr>
                            <th rowSpan="2" className="bold500"
                                style={{borderBottom: 0, paddingBottom: 0, textAlign: 'left'}}>Month End
                            </th>
                            <th colSpan="2" className="bold500" style={{borderBottom: 0, paddingBottom: 0}}>VaR
                                Historical
                            </th>
...
function BarChart(props) {
    let bardata = ["0.00", "0.00", "0.02", "0.09", "0.31", "0.80", "1.73", "3.21", "5.17", "7.37", "9.43", "10.92", "11.54", "11.21", "10.08", "8.41", "6.56", "4.79", "3.29", "2.13", {
        value: 1.31,
        itemStyle: {color: '#D91E18'}
    }];
    let max = bardata[0] * 1;
    bardata.forEach(v => {
        let n;
