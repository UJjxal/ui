...
import {Alert, Button, Col, Form, Input, Layout, Row, Tabs} from "antd";
...
import {API_ROOT, CONTEXT, s3Url, STATICMRM} from "../../../../config";
                                    ...
                                    {this.state.apiListResponse ? (
                                                        ...
                                                        <Row>
                                                            <Col className="w-100">
                                                                <div className="border radius6 p15">
                                                                    <strong>MODEL
                                                                        OBJECTIVE:</strong> {this.state.objective}
                                                                </div>
                                                            </Col>
                                                        </Row>}
                                                    ...
                                                    {this.state.apiResponse ? (
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            >
                                                                                {this.state.modelDetails.DataOverview ? (
                                                                                    <TabPane tab="Data Overview"
                                                                                             key={1}>
                                                                                        <DataOverview
                                                                                            apiData={this.state.modelDetails}/>
                                                                                            ...
                                                                                            if (item.key === 3) {
                                                                                                if (dev == 0 && val >= 1) {
                                                                                                    return (
                                                                                                        <Alert
                                                                                                            className="mt-3"
                                                                                                            message="Model validation may not be accurate as there are no defaults in the development set."
                                                                                                            type="info"
                                                                                                            showIcon
                                                                                                            banner/>
                                                                                                    )
                                                                                                    ...
                                                                                                    return (
                                                                                                        <Alert
                                                                                                            className="mt-3"
                                                                                                            message="Model validation  is not possible as there are no defaults in the development or validation set."
                                                                                                            type="info"
                                                                                                            showIcon
                                                                                                            banner/>
                                                                                                    )
                                                                                ...
                                                                                {(this.state.modelDetails.Discrimination_Table || this.state.modelDetails.Final_Rating || this.state.modelDetails.Quantitative_Rating || this.state.modelDetails.Qualitative_Rating) ? (
                                                                                    <TabPane tab="Model Discrimination"
                                                                                             key={2}>
                                                                                ...
                                                                                {this.state.PSI ? (
                                                                                    <TabPane tab="Population Stability"
                                                                                             key={4}>
                                                                                        {this.state.modelDetails ? (
                                                                                            <Stability
                                                                                                apiData={this.state.modelDetails}/>
                                                        ...
                                                        <div>
                                                            {this.state.modelId.length ? (
                                                                ...
                                                                <div className="p50 text-center">Please Select Model ID
                                                                    or Any Filter</div>
                                                            )}
                                                        </div>
                                                    )}
                                        ...
                                        <div>
                                            {this.state.modelId.length ? (
                                                ...
                                                <div className="p50 text-center">Please Select Model ID or Any
                                                    Filter</div>
                                            )}
                                        </div>
                                    )}
