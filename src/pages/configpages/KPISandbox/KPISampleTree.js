...
import {MDBCard, MDBCardGroup, MDBCardText, MDBContainer,} from "mdbreact";
                ...
                KPI Tree
                                    ...
                                    <MDBCardText>
                                        {this.props.sampleTree ? (
                                            <TreeChart treeData={this.props.sampleTree}
                                                       colorThreshold={this.props.colorThreshold}/>
                                        ) : <div className="text-center">Create a sample KPI structure at KPI
                                            Configuration</div>}
                                    </MDBCardText>
                                </MDBCard>
                            </MDBCardGroup>
