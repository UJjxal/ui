...
import {addDataCatalog, dataCatalog, deleteDataCatalog, updateDataCatalog} from '../../../../components/DataCatalog';
            ...
            >
                ...
                {props.selectedRnd.dataNode
                    ...
                    <FormControl variant="outlined"
                                 style={{width: '100%', marginTop: "1rem", borderColor: props.theme.color6}}>
                        <InputLabel className={`text-${props.theme.color6}`} style={{borderColor: props.theme.color6}}
                                    id="demo-simple-select-outlined-label">Select Metrics</InputLabel>
                        <Select
                ...
                <div className="d-flex flex-row justify-content-between mt-3">
                    <Button variant="outlined" type="primary" onClick={() => cleanupClose()}
                            style={{color: props.theme.color6, borderColor: props.theme.color6}}>
                        Close
                    </Button>
                    {
                ...
                >
                    {//LC-723 Parameterized SQL Queries
                        props.drawerSelected === 'parameter'
                            ? <ParameterTreeList treeData={props.allParametersList}
            ...
            <ul className="tree-list list-inline" style={{font: 'Roberto', fontWeight: 'bold'}}>
                {
                    data[`optionsForDataField`].map((x, i) => (
                        <li key={i} className="my-1 cursor-pointer">
                            <span onClick={() => showChild(i)}><Icon
                                className="align-middle">arrow_right</Icon>{x.title}</span>
                            <ul className="list-inline pl-4 d-none">
                                <li className="add-new-item">
                                    ...
                                    <div className="position-relative border rounded mb-2 d-none">
                                        <input className="form-control border-bottom" placeholder="Column name..."
                                               style={{border: 0, borderRadius: 0, boxShadow: 'none'}}/>
                                        <textarea className="form-control border-0"
                                                  placeholder="Write expression here..." style={{boxShadow: 'none'}}/>
                                        <div className="d-flex justify-content-between">
                                            <Button color="primary"
                                                    onClick={() => addData(i, x.type, x.title, x.schema)}>ADD</Button>
                                    ...
                                    <li key={idx} className="py-1 pl-2 cursor-pointer">
                                        ...
                                        <div className="position-relative border rounded my-2 d-none">
                                            {(x.children.length > 1) &&
                                                <Button color="primary"
                                                    ...
                                                    <Icon className="align-middle"
                                                          title="Delete Column">delete_forever</Icon>
                                                </Button>
                                            }
                                            ...
                                            <input className="form-control border-bottom" placeholder="Column name..."
                                                   ...
                                                   style={{border: 0, borderRadius: 0, boxShadow: 'none'}}/>
                                            <textarea className="form-control border-0"
                                                      placeholder="Write expression here..." defaultValue={w.expression}
                                                      style={{boxShadow: 'none'}}/>
                                            <div className="d-flex justify-content-between">
                                                <Button color="primary"
                                                        onClick={() => updateData(i, idx + 1, x.type, x.title, w.title, x.schema)}>UPDATE</Button>
                                                {
                                                    (w.expression.length > 0) &&
                                                    <Button color="primary"
                                                            onClick={() => getTextareaValue(i, idx + 1)}>USE
                                                        EXPRESSION</Button>
                                                }
                                            </div>
                                        </div>
