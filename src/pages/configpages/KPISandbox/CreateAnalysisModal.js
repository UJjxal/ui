        ...
        <AppContext.Consumer>
            {
                ({
                    ...
                    >
                        ...
                        <MDBModalFooter
                            className="d-flex flex-row align-items-center justify-content-between mb-3 ml-2">
                            ...
                            >
                                {<NavLink
                                    to={selectedKPILink ? selectedKPILink : GATEWAYBASED ? CONTEXT + selectedUsecaselink : "/"}>
                                    CANCEL
                                </NavLink>}
                            </Button>
