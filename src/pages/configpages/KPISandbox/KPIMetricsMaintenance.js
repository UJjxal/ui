...
import {unitList} from '../../../utilities/AllTables';
...
const KPIMetricsMaintenance = (props) => {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: "_description",
            render: (_, record) => {
                return <p style={{maxWidth: "250px"}}>{record.description}</p>
            }
        },
        {
            title: "Polarity",
                ...
                {availableMetricsList.length > 0 || create ?
                    ...
                    <div className="w-100 row align-items-center justify-content-center my-5">
                        ...
                        <div className="col-md-4 text-center">
                            ...
                            <p className="fs16">There are no metrics created yet. Metrics help you track and manage
                                strategies to improve your Key Metrics. Click the New Metric button to get started.</p>
                        </div>
                    </div>
                }
            </div>
            ...
            <div className="d-flex justify-content-between border-bottom pb-3 mb-4">
                ...
                <div>
                    <IconButton className="outline-none mr-3" size="small" color="primary" aria-label="delete"
                                onClick={() => deleteMetrics([selectedItem.key])}>
                ...
                <form onSubmit={handleSubmit}>
                        ...
                        <div className="col">
                            <FormControl fullWidth className="pb-4">
                                ...
                                <Select
                                    ...
                                    label="Polarity"
                                >
                                    {['Positive', 'Negative'].map((item, i) => <MenuItem key={i}
                        ...
                        <div className="col">
                            <FormControl fullWidth className="pb-4">
                                ...
                                <Select
                                    ...
                                    label="Format"
                                >
                                    {unitList.map(item => <MenuItem key={item.key}
                    ...
                    <FormControl fullWidth>
                        ...
                        <div className="d-flex align-items-center justify-content-between pt-1">
                            <Button className="outline-none" size="small" color="primary"
                                    onClick={() => setIsDrawer('column')}>SELECT COLUMN</Button>
                            <Button className="outline-none" size="small" color="primary"
                                    onClick={() => getOptionsForParameters()}>SELECT PARAMETER</Button>
                        </div>
                    </FormControl>
