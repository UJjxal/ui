...
import {FormControl, Icon, IconButton, Input, InputLabel, Link, MenuItem, Select} from '@material-ui/core';
        ...
        <>
            <div id="metrics-parent">
                ...
                {props.filterList.map((filter, i) => {
                    console.log(props.allFilters, filter)
                        ...
                        <div className="d-flex flex-column" key={i}>
							<span className="ml-5 mb-3 font-weight-bold">
								{ //SI-103 Provide Filter 
                                    ...
                                    // ?
                                    <Input placeholder={`Filter ${i + 1}`} value={filter.label}
                                           onChange={(e) => props.handleFilterLabelChange(e, i)}/>
                            ...
                            <div className="ml-5 mt-1">
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {props.allFilters.map((val) => <MenuItem key={val.filter}
                                                                                 value={val.filter}>{val.filter}</MenuItem>)}
                                    </Select>
                                </FormControl>
