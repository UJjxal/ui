        ...
        if (isEdit === insightsId) {
            return <div className="w-100 border rounded mb-3 add-new-insight">
                <textarea onChange={(e) => setTextarea(e.target.value + '\r\n')} placeholder="Enter your insight here"
                          className="w-100 p-3 border-0">{insightsValue}</textarea>
                <div className="d-flex justify-content-end py-1 px-2 add-new-insight-footer"
                    ...
                    <MDBBtn size="md" color="primary" style={{boxShadow: 'none'}}
                            ...
                            onClick={() => {
                                props.updateInsightsData(props.nodeId, insightsId, textarea, props.user);
                                setEdit(false);
                            }}
                    >Submit</MDBBtn>
                </div>
            ...
            <div className="d-flex justify-content-end align-items-center pb-2 border-bottom">
                {props.user.userMail === email && <>
                    ...
                    <Button size="small" className={'bg-primary-blue text-white px-3 py-1'}
                            onClick={() => {
                                props.deleteInsightsData(props.nodeId, insightsId);
                                setEdit(false);
                            }}>
                        Delete
                    </Button>
                    ...
                    <div className="w-100 border rounded mb-3 add-new-insight">
                        ...
                        <div className="d-flex justify-content-end py-1 px-2 add-new-insight-footer"
                            ...
                            <MDBBtn size="md" color="primary" style={{boxShadow: 'none'}}
                                    disabled={textarea.length > 0 ? false : true}
                                    onClick={() => {
                                        props.createInsightsData(props.nodeId, textarea, props.user);
                                        setActiveNewInsight(false);
                                    }}
                            >Submit</MDBBtn>
                        </div>
                    ...
                    insights.length > 0 ? _keyInsights :
                        <div className="w-100 row align-items-center justify-content-center my-5">
                            ...
                            <div className="col-md-4 text-center">
                                ...
                                <p className="fs16">There are no Key Insights for this node. The business analysts and
                                    executives can share their insights here as a result of their Root Cause
                                    Analysis.</p>
                            </div>
                        </div>
                }
