            ...
            <div className={className} style={{border: `2px solid ${nodeDatum.error === "" ? "#6885A3" : "#ff4141"}`}}>
                ...
                <div className="d-flex flex-column justify-content-center position-relative pl-3 node-status">
                    {options !== nodeDatum.nodeId ?
                        <IconButton className="outline-none bg-white icon-btn-shadow p-2" size="small" color="primary"
                                    aria-label="edit"
                    ...
                    <div className="position-absolute"
                         style={options === nodeDatum.nodeId ? {
                             left: '70px',
                             visibility: 'visible',
                             opacity: 1,
                             transition: 'all 0.2s linear 0s'
                         } : {left: '50px', visibility: 'hidden', opacity: 0, transition: 'all 0.2s linear 0s'}}>
                        <IconButton className="outline-none bg-white icon-btn-shadow p-2" size="small" color="primary"
                                    aria-label="drive_file_rename_outline"
