...
import {MDBBtn, MDBCard, MDBContainer, MDBIcon, MDBTable, MDBTableBody, MDBTableHead,} from 'mdbreact';
                    ...
                    return (
                        ...
                        >
                            ...
                            >
                                ...
                                >
                                    <div>
                                        <h5 className="mt-2 text-center" style={{color: theme.color6}}>Root Cause
                                            Analysis</h5>
                                                            ...
                                                            if (key[0] != 'node_status') {
                                                                return (
																	...
																	<span className="side-node-attr-1">
                                                                        ...
                                                                        <span
                                                                            className="side-node-attr-2">{key[0]}</span>
                                                                    </div>
                                                                );
                                                            }
                                                        })}
