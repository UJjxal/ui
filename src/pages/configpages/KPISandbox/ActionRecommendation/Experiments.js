...
import {MDBIcon, MDBModal, MDBModalBody, MDBModalFooter} from 'mdbreact';
    ...
    return (
        <div>
                ...
                <ul className="list-inline mb-4">
                    {
                        KPIDomainList.map((displayName, i) =>
                            <li key={i} className="list-inline-item">
                                <label
                                    className={((data['domain'] !== displayName) ? `pills w-auto px-3` : `pills w-auto px-3 bg-primary border-primary text-white`)}>
                ...
                <ul className="list-inline mb-4">
                    {
                        ['Recommendation 1', 'Recommendation 2', 'Recommendation 3', 'Recommendation 4'].map((displayName, i) =>
                            <li key={i} className="list-inline-item">
                                <label
                                    className={((data['recommendation'] !== displayName) ? `pills w-auto px-3` : `pills w-auto px-3 bg-primary border-primary text-white`)}>
                                    <input name={displayName} type="checkbox" className="d-none"
            ...
            <div className="form-group mt-4 pt-3">
                ...
                <div>
                    <RadioGroup className="flex-row" value={data['audience']}
            ...
            <div className="form-group mt-4 pt-3">
                <h5>Split Type</h5>
                <div>
                    <RadioGroup className="flex-row" value={data['split']}
                        ...
                        <FormControlLabel value="Absolute Value" control={<Radio color="primary"/>}
            ...
            <div className="form-group mt-4 pt-3">
                ...
                <div>
                    <RadioGroup className="flex-row" value={data['duration']}
    ...
    return (
        <div>
            <div className="form-group mt-4 pt-3">
                ...
                <p className="p-2 border">80% of your midwest customers are likely to buy credit cards with credit limit
                    of more than $10000.</p>
            </div>

            {
                inputs.map((input, i) => (
                    <div key={i} className="form-group mt-4 pt-3">
                        ...
                        <div>
                            <TextField variant="outlined" placeholder="Define your variant here" className="split-desc"
                                       style={{width: "50rem"}}/>
                            <OutlinedInput
                            ...
                            />
                            {
                                i === (inputs.length - 1) ?
                                    <Button color="primary" className="outline-none"
                                            onClick={() => setInputs([...inputs, `input-${inputs.length}`])}>+ Add
            ...
            <div className="d-flex justify-content-between">
                ...
                <Button variant="contained" color="primary" style={{backgroundColor: '#3f88c5'}}
                        onClick={() => getVariantValues()}>Preview</Button>
            </div>
    ...
    return (
        <MDBModal isOpen={props.isOpen} toggle={props.setIsOpen} className="cascading-modal px-5 my-5" size="fluid">
            <div className="py-3 px-4 d-flex align-items-center justify-content-between"
                ...
                <button className="border-0 bg-white" onClick={() => props.setIsOpen(false)}><MDBIcon icon="times"/>
                </button>
            </div>
            ...
            <MDBModalFooter className="d-flex justify-content-between">
                <Button variant="contained" color="primary" style={{backgroundColor: '#DFC575'}}
                        onClick={() => props.setIsOpen(false)}>Make Changes to this Test</Button>
                <Button variant="contained" color="primary" style={{backgroundColor: '#15995E'}}>Run this
                    Experiment</Button>
            </MDBModalFooter>
        </MDBModal>
    )
